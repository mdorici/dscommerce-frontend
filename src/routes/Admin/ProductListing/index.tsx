...
export default function ProductListing() {
  ...
  function handleDialogConfirmationAswer(answer: boolean, productId: number) {
    if(answer === true) {
          ...
          <tbody>
            {products.map((product) => (
              <tr key={product.id}>
                ...
                <td>
                  <img onClick={() => handleUpdateClick(product.id)} className="dsc-product-listing-btn" src={editIcon} alt="Editar" />
                </td>
                <td>
...

{
        ...
        onDialogAnswer={handleDialogConfirmationAswer} />
      }
